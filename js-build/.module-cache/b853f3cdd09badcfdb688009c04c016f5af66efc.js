...
class Form extends React.Component
{
            ...
            if (item.status === "edit")
            {
                return (
                    React.createElement("tr", {key: id}, 
                        ...
                        React.createElement("td", null, React.createElement("button", {name: "new_item", onClick: this.updateItem.bind(this, item, id)}, "Update")), 
    ...
    updateItem(item, id, event)
    {
        ...
        }).then((response) =>
        {
            ...
            if (id == response.data.id && item.new_value === response.data.new_value)
            {
